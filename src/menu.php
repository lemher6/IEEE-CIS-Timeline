...
<div class="bar">
  ...
  <button onclick="document.location='/src/edit-events.php'">Update Events</button>
  <?php
  ...
  ?>
    ...
    <button onclick="document.location='/src/sandbox-timeline.php'">Sandbox View</button> <!-- Using JSON file -->
  <?php
    } // END if userRoll
  ?>
  <button onclick="document.location='/src/timeline-Launch.php'">Production View</button> <!-- Using JSON file -->

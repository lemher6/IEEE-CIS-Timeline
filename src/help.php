      ...
      <div class="content">
        ...
        <span id="creating"> </span>
          ...
          <ul class="helpItem">
            ...
            <li>Field the event information <a href="#Enfio"><button type="button" class="qButton">?</button></a>. Every event must have at least a title and a start date.</li>
          ...
          <ol class="helpItem">
            ...
            <li><b>Event Group:</b> By default, will be set CIS group, but you can select any of the options (FUZZI, EC, NNs).</li>
              <img class="helpImg" src="/img/EventGroup.png" width="80%" title="Event Group">
            <span id="Ecolor"> </span>
            <li><b>Slide Background Color:</b> Each event has a slide in the timeline and you can choose a different background color for it. Click on the color box to display the browser's color box tool.</li>
              <img class="helpImg" src="/img/EventColor.png" width="80%" title="Event Color">
            <span id="Eheadline"> </span>
            <li><b>Event Headline:</b> The headline will be displayed below the dates in a large font size. It also will be display in the navigation bar. This field is required.</li>
              <img class="helpImg" src="/img/EventTexting.png" width="80%" title="Event Headline">
            ...
            <li><b>Event Detail 1:</b> The first detail will be placed in a different line below the title in a small letter.</li>
              <img class="helpImg" src="/img/EventDetails.png" width="80%" title="Event Headline">
            ...
            <span id="Edates"> </span>
            <li><b>Start Date:</b> Every event must have a start and end date. You can type in the month, day, and year when the event starts, or you can click on the calendar icon at the end of the line to display the browser's calendar tool.</li>
              <img class="helpImg" src="/img/EventDates.png" width="80%" title="Event Start and End Dates">
            ...
            <li><b>Media URL:</b> This Timeline can pull in media from a variety of sources and has built-in support for Images, Twitter, Instagram, Flickr, Google Maps, DropBox, DocumentCloud, Wikipedia, SoundCloud, Storify, iframes, and the major video sites (YouTube, Vimeo, etc.) Include the URL where the media file is located for example(https://cis.ieee.org/images/IEEE_CIS_logo.jpg)</li>
              <img class="helpImg" src="/img/EventMedia.png" width="80%" title="Event Media">
            ...
            <li>Include the comments/reason about the new event at the end of form and click on the "Create" button to submit the form.</li>
              <img class="helpImg" src="/img/EventComments.png" width="80%" title="Event Media">
          </ol>
        ...
        <span id="waiting"> </span>
          <h2>Review and Update your "Waiting for Approval" Requests</h2>
          <ul class="helpItem">
